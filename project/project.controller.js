...
exports.createProject = async function(req, res) {
    ...
    project.save().then((data) => {
        ...
        res.status(500).send({message: "Internal Server Error: Cannot save the Project"})
    })   
}

exports.updateProject = async function(req, res) {

    const project = await ProjectModel.findByIdAndUpdate({_id: req.params.projectID}, req.body)
...
exports.deleteProject = async function(req, res) {
    ...
    const project = await ProjectModel.findOneAndDelete({_id: req.params.projectID})
...
exports.addResource = async function(req, res) {
    ...
    resource.save().then((data) => {
        ...
        res.status(500).send({message: "Internal Server Error: Cannot save the Resource"})
    })
}
